...
We develop plugin to do it as optimized as possible, CleanTalk doesn't downgrade response time in backend or frontend. The plugin process only POST requests to WordPress core, it tackes less than 1 second to return results. Here are some P3 Profiler results from a real WordPress blog,
...
== Changelog ==
= 5.31.1 2015-11-13 =
  * Fixed Spam FireWall logs sending
...
= 5.28 2015-10-16 =
  ...
  * Restored options for spam checking registrations and common contact forms
