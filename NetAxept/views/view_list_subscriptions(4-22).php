    ...
    <table class="wp-list-table widefat fixed posts tablesorter" id="myTable">
        <thead>
            <tr>
                ...
                <th>Collect Payment <?php echo((isset($_REQUEST['collect'])) ? ' <input type="button" name="collect_all" id="collect_all" value="Collect All" class="button" onclick="collectPaymentFromAll();" />' : ''); ?></th>
            </tr>
        </thead>
