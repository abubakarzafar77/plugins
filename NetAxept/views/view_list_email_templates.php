...
if(isset($email_template_to_edit)){
			...
			else if($template_type == "ssubscription_expired")
			{
...
?>
	...
	<div class="wrap">
    	<form action="?page=email_templates&id=<?php echo $template_type;?>" method="post">
        ...
        <table class="wp-list-table widefat fixed posts tablesorter" id="myTable">
            ...
            <tbody>
                ...
                foreach($config['email_templates'] as $name=>$body){
					...
					{
						$template_name = 'Expired Subscription';
						$email_subject = $body['subject'];
					}	
                ...
                <tr>
                    ...
                    <td><a href="?page=email_templates&id=<?php echo $name;?>">Edit</a></td>
                </tr>
                <?php 
                    $i++;
                }?>
