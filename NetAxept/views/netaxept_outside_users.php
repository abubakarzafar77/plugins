...
<div class="wrap">
	<form action="admin.php?page=netaxept_outside_users" method="post">
    ...
    <table class="wp-list-table widefat fixed posts">
		...
		?>
                <tbody>
                    ...
                    <td><a href="admin.php?page=netaxept_outside_users&key=<?php echo $key;?>&action=delete">Delete</a></td>
                </tbody>
        <?php 
				}
			}else{
