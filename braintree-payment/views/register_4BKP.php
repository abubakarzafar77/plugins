...
<div id="payment_box">
    ...
    <?php
        ...
        <p><?php echo utf8_encode('Brukernavn og passord sendes på epost straks banktransaksjon er godkjent. Viktig! Noen epostklienter som hotmail.no og online.no kan filtrere eposter inn som søpplepost, eller spam. Sjekk derfor spam eller søppelfilter for å se om eposten kan ha havnet der, dersom du ikke mottar innloggingsepost på vanlig innboks.');?></p>
