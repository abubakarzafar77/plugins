...
function gcse_request($page = 1)
{
    ...
    if(isset($options['key']) && $options['key'] &&
        ...
        // Build URL
        $num    = isset($wp_query->query_vars['posts_per_page']) && $wp_query->query_vars['posts_per_page'] < 11 ?$wp_query->query_vars['posts_per_page'] : 10;
        //$start  = isset($wp_query->query_vars['paged']) && $wp_query->query_vars['paged'] ?($wp_query->query_vars['paged']-1)*$num+1 : 1;
		$start  = isset($page) && $page ?($page-1)*$num+1 : 1;
