...
echo '<p>';
printf(__('This questionare has received a total of %s%d%s responses', 'awesome-surveys'), '<b>', count($results), '</b>');
echo '</p>';
...
foreach ($answer_book as $question => $ans)
{
    ...
    printf(__('%s received %s%d%s responses', 'awesome-surveys'), $elements[$question]['name'], '<b>', $total, '</b>');
    echo '</p>';
// for k
...
<div id="piechart_3d" style="width: 900px; height: 500px; margin-top:17%;"></div>
</div>
</div>
