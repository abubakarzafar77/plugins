...
if(count($past_due) > 0){
    ?>
    <?php if(count($past_due) > 1){?>
        <div class="w-clearfix">
            <div class="j-pagging">
                <a href="javascript:void(0);" class="previous_job" data-id="<?php echo $count-1;?>"><</a>
                <span class="shown">1</span><span>/</span><span class="of"><?php echo count($past_due);?></span>
            ...
            <div class="w-clearfix j-outer job_outer" id="job_<?php echo $count;?>"<?php echo $style;?>>
                <section class="job w-clearfix">
                    <div class="j-top-meta w-clearfix">
                        ...
                        <div class="j-delete-btn"><a href="<?php echo wp_nonce_url(home_url('studiekamerat?page=past_due&action=delete_job&job_id='.$job->ID), 'delete_job', 'delete_job');?>" onclick="return confirm('Are you sure you want to delete?');" class="btn j-btn">Slett utgått bestilling</a></div>
                    </div>
