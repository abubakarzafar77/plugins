...
define('GOTOWP_PERSONAL_PLUGIN_VERSION', '1.1.5');
            ...
            <div id="tab0_content" class="tabsCntents">
                <form name="gotowp_training_settings" id="gotowp_training_settings" action="" method="post">
                    ...
                    <table class="tableborder">
                        <tr>
                            <td class="gotowp-description tableclass" colspan="2">The <b style="color:#090;">Organizer Key</b> and <b style="color:#090;">Access Token</b> can be obtained from online application after authenticating with O-Auth connector for webinars (G2T OAuth Flow) by clicking the link below. Keys generated through app.gotowp.com are stable for 1 year
                                <br>
                                <a href="http://app.gotowp.com/" target="_blank"><b>http://app.gotowp.com/</b></a></td>
                        </tr>
                        <tr>
                            <th colspan="2" class="tableheader">
                                <?php _e('GotoTraining Access Details'); ?>
                            </th>
                        </tr>
                        <tr>
                            <td class="tableclass">
                                <?php _e('Organizer Key'); ?>
                            </td>
                            <td>
                                <input type="text" size=40 value="<?php echo trim(get_option('gotowp_training_personal_organizer_key')); ?>" name="training_organizer_key" id="training_organizer_key" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tableclass">
                            ...
                            <td>
                                <input type="text" size=40 value="<?php echo trim(get_option('gotowp_training_personal_access_token')); ?>" name="training_access_token" id="training_access_token" />
                            </td>
                        </tr>

                        <tr>
                            <td class="tableclass">
                                <input type="hidden" name="action" value="save_training_settings" />
                            </td>
                            <td>
                                <input style="" class="submit_btn" type="submit" name="submit" value="<?php _e('Save Details') ?>" />
                            </td>
                        </tr>
                            ...
                            <table id="gotowp_training_personal_sample_table" class="tableborder">
                                <thead>
                                    <tr class="heading_row">
                                        <th colspan="2" class="tableheader heading">
                                            <?php _e('Sample Usage Shortcode On Registration Page'); ?>
                                                <br/>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="sample_row" style="">
                                        ...
                                        <td class="sample_field">
                                            <input style="width:500px;padding:5px 20px;" type="text" size=40 value="[register_free_training id=xxxxxxxxxxxx page_id=xxx]" name="shortcode" class="shortcode" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            <div id="tab1_content" class="tabsCntents">
                        ...
                        <form name="gotowp_personal_adminsettings" id="gotowp_personal_adminsettings" action="" method="post">
                            <table class="tableborder">
                                <thead>
                                    <tr>
                                        <th colspan="2" class="tableheader">
                                            <?php _e('Webinar Details'); ?>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="gotowp-description tableclass" colspan="2">The <b style="color:#090;">Organizer Key</b> and <b style="color:#090;">Access Token</b> can be obtained from online application after authenticating with O-Auth connector for webinars (G2W OAuth Flow) by clicking the link below. Keys generated through app.gotowp.com are stable for 1 year
                                            <br>
                                            <a href="http://app.gotowp.com/" target="_blank"><b>http://app.gotowp.com/</b></a></td>
                                    </tr>
                                    <tr>
                                        <td class="gotowp-organizer-key tableclass">
                                            <?php _e('Organizer Key'); ?>
                                        </td>
                                        <td>
                                            <input type="text" size=40 value="<?php echo trim(get_option('gotowp_personal_organizer_key')); ?>" name="gotowp_personal_organizer_key" id="gotowp_personal_organizer_key" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="gotowp-access-token tableclass">
                                            <?php _e('Access Token'); ?>
                                        </td>
                                        <td>
                                            <input type="text" size=40 value="<?php echo trim(get_option('gotowp_personal_access_token')); ?>" name="gotowp_personal_access_token" id="gotowp_personal_access_token" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="gotowp-action-hidden tableclass">
                                            <input type="hidden" name="action" value="gotowp_personal_savefreewebinar" />
                                        </td>
                                        <td>
                                            <input class="gotowp-submit-button" id="savefreewebinar_submit" style="" type="submit" name="submit" value="<?php _e('Save Details') ?>" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <form name="gotowp_personal_webinar_forms" id="gotowp_personal_webinar_forms" action="" method="post">
                    <table class="tableborder">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <p class="gotowp-description">If you edit GoToWebinar's registration form after you create a webinar,
                                        <br/> you can display these changes on your Wordpress site by using the Refresh Webinar forms feature</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                ...
                <table id="gotowp_personal_sample_table" class="tableborder">
                    <thead>
                        <tr class="heading_row">
                            <th colspan="2" class="tableheader heading">
                                <?php _e('Sample Usage of Shortcode'); ?>
                                    <br/>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="sample_row" style="">
                            <td style="" class="tableclass sample_title">
                                <?php _e('On Registration Page'); ?>
                            </td>
                            <td class="sample_field">
                                <input style="" type="text" size=40 value="[register_free_webinar webid=xxxxxxx pageid=xxx]" name="shortcode" class="shortcode" />
                            </td>
                        </tr>
                    </tbody>
                </table>
	...
	if(isset($registration_fields->fields) && is_array($registration_fields->fields)){
			...
			if(isset($registration_fields->fields) && count($registration_fields->fields) > 0){
		      ...
		      if(isset($registration_fields->questions) && count($registration_fields->questions) > 0){
		      	...
		      	$output.='<tr class="gotowp-'.$row->questionKey.'"><td><label>'.$row->question.':</label></td>';
