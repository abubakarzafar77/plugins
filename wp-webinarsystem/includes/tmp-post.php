                    ...
                    <div class="col-lg-5 col-sm-6 col-md-5 col-xs-12">
                        <div class="tickets" style="border: 2px <?php echo $the_tnxp_ticket_border_color ?> dashed; background-color: <?php echo $the_tnxp_ticket_background_color ?>;">
                            ...
                            <div class="ticket-bottom" style="background-color: #fbd35d;">
                                <div class="ticket-bottom" style="background-color: <?php echo $the_tnxp_ticket_body_background_color ?>;">
                                    ...
                                    <div style="padding:10px;"><a id="view-webinar-button" href="<?php echo get_permalink(); ?>" style="width:100%; <?php echo $the_tnxp_ticket_button_color . ';' . $the_tnxp_ticket_buttonb_color . ';' . $the_tnxp_ticket_button_text_color; ?>;" class="btn <?php echo ($hide ? 'hidden' : '') ?>">
                                            <?php
                                            switch ($wbstatus):
                                                case 'liv':
                        ...
                        <div class="tnxp-box" style="background-color: <?php echo $data_tnxp_socialsharing_bckg_clr ?>;border-color: <?php echo $data_tnxp_socialsharing_border_clr ?>;">
                            <div class="social-buttons">
                                ...
                                <span>
                                    <a href="#" onClick="window.open('http://www.linkedin.com/shareArticle?mini=true&url=<?php echo get_permalink($post->ID); ?>&title=<?php echo get_the_title(); ?>&summary=<?php echo wp_strip_all_tags(get_the_content(), true); ?>', 'webinar-linkedin', 'width=500,height=500')"><img src="<?php echo plugins_url('./images/ui/li.png', __FILE__); ?>"/></a>
                                </span>
                            </div>
                        </div>
                        <?php
