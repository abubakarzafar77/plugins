        ...
        <div class="container">
            ...
            <div class="row">
                <?php if ($data_show_desc == 'yes' || $data_show_presenter == 'yes'): ?>
                    ...
                    <?php endif; ?>
                        <div id="wswebinar-live-page-ask-question-form" class="round-border signup" style=" margin-top: 10px; background-color: <?php echo $data_livep_askq_bckg_clr ?>;border-color:<?php echo $data_livep_askq_border_clr ?>;<?php echo ${'data' . $page_status . '_show_quebox'} == 'yes' ? '' : 'display:none;' ?>">
                            <h2 style="color:<?php echo $data_askq_title_text_clr; ?>;" class="live-title-sub"><?php _e('Ask your question! ' . $data_replay_show_quebox, WebinarSysteem::$lang_slug) ?></h2>
